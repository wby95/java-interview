# 数据库 
 ...
 - 索引 https://baike.baidu.com/item/%E6%95%B0%E6%8D%AE%E5%BA%93%E7%B4%A2%E5%BC%95/8751686?fr=aladdin
     - 什么是索引：是对数据库表中的一列&几列的值进行排序的一种结构。
     - 索引的优点
     ...
     - 常见的索引类型：
       - B-Tree 索引:全值索引&匹配最左前缀&匹配列前缀&匹配范围值&精确匹配某一列并范围匹配到另外一列&只访问索引的查询
           ![B-Tree索引.jpg](B-Tree索引.jpg)
       - 哈希索引
       - 空间数据索引
       - 全文索引
       - 其他索引类别
